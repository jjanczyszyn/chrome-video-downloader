...
export const MSG = {
  ...
  DOWNLOAD_VTTS: 'DOWNLOAD_VTTS',       // download only VTT files
  EXPORT_INDEX: 'EXPORT_INDEX',         // full course JSON+MD
  EXPORT_M3U8_INDEX: 'EXPORT_M3U8_INDEX', // m3u8+VTT map JSON+MD
